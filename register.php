...
<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" id="subject" class="form-control" placeholder="Enter City Here">
								</div>
							</div>
<div class="row form-group">
								<div class="col-md-12">
									<label for="subject">Contact</label>
									<input type="text" id="subject" class="form-control" placeholder="Enter Contact Here">
								</div>
							</div>

							<div class="row form-group">
								<div class="col-md-12">
                                                                    <a for="message" href="Login.php">Login</a>
