...
//                $name=$_GET['StudName'];
//                    echo $name;
                $query1="SELECT * FROM `package_tbl` where cat='Birthday Party'";
                $result1=$empmgt->query($query1);
                ...
                while($row=$result1->fetch_assoc()){ ?>
							<div class="item">
								...
								<div class="desc text-center">
									...
									<h3><a href="rooms-suites.html"><?php echo $row['p_name']?></a></h3>
									<p class="price">
										<span class="currency">Rs</span>
										<span class="price-room"><?php echo $row['p_cost']?></span>
										<!--<span class="per"></span>-->
									</p>
<!--									<ul>
									...
									<p><a class="btn btn-primary btn-book" href="Booking.php?pck=Package 1">Book now!</a></p>
								</div>
                </div><?php }}?>
<!--							<div class="item">
								...
								<div class="desc text-center">
									...
									<h3><a href="rooms-suites.html">Package 2</a></h3>
									<p class="price">
									...
									<p><a class="btn btn-primary btn-book" href="Booking.php?pck=Package 2">Book now!</a></p>
								</div>
							</div>
							<div class="item">
								...
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.html">Package 3</a></h3>
									<p class="price">
										<span class="currency">$</span>
									...
									<p><a class="btn btn-primary btn-book" href="Booking.php?pck=Package 3">Book now!</a></p>
								</div>
							</div>
							<div class="item">
								...
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.html">Package 4</a></h3>
									<p class="price">
										<span class="currency">$</span>
									...
									<p><a class="btn btn-primary btn-book" href="Booking.php?pck=Package 4">Book now!</a></p>
								</div>
							</div>
							<div class="item">
								...
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.html">Package 5</a></h3>
									<p class="price">
										<span class="currency">$</span>
									...
									<p><a class="btn btn-primary btn-book" href="Booking.php?pck=Package 5">Book now!</a></p>
								</div>
							</div>
							<div class="item">
								...
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
									<h3><a href="rooms-suites.html">Package 6</a></h3>
									<p class="price">
									...
									<p><a class="btn btn-primary btn-book"    href="Booking.php?pck=Package 6">Book now!</a></p>
								</div>
							</div>-->
						</div>
					</div>
