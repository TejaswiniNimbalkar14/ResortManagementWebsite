                            ...
                            <div class="row form-group">
								<div class="col-md-6">
									<label for="fname">Package Name</label>
                                                                        <input type="text" id="fname" class="form-control" name="pckgname" value="<?php echo $_GET['pck']; ?>" placeholder="Your firstname" readonly>
								</div>
								<div class="col-md-6">
									<label for="fname">Name</label>
                                                                        <input type="text" id="fname" class="form-control" name="cname" placeholder="Enter Name Here">
								</div>
							</div>
<!--							<div class="row form-group">
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label for="subject">Contact</label>
                                                                        <input type="text" id="subject" class="form-control" name="cont" placeholder="Enter Contact Here">
								</div>
							</div>
<div class="row form-group">
								<div class="col-md-12">
									<label for="subject">Date</label>
                                                                        <input type="date" id="subject" class="form-control" name="date" placeholder="Enter Contact Here">
								</div>
							</div>
